...
public class EmotionActivity extends AppCompatActivity {
    public static String emotionVar;
    private Button lmBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View lmBtnVis = findViewById(R.id.learnMoreBtn);
        lmBtnVis.setVisibility(View.GONE);
        lmBtn = findViewById(R.id.learnMoreBtn);
        lmBtn.setOnClickListener(new View.OnClickListener(){
            @Override
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(EmotionActivity.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.CAMERA}, REQUEST_PERMISSION_CODE);
    }
     ...
     */
    public class GetEmotionCall extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                View lmBtnVis = findViewById(R.id.learnMoreBtn);
                lmBtnVis.setVisibility(View.VISIBLE);
